...
custom_salinity = cm.YlGnBu_r
custom_anomaly = cm.RdBu_r
custom_temperature = cm.autumn_r
custom_density = cm.BuPu
custom_viridis = ListedColormap(_viridis_data, name='viridis')

GMT_relief = basemap_cm.GMT_relief
GMT_no_green = basemap_cm.GMT_no_green

default = custom_viridis
